...
const FeatureCard = ({ title, imgSrc, exploreUrl }) => {
  return (
    <div className="last:relative  md:last:static w-46 md:w-80 h-[12rem] md:h-[22rem] rounded z-10 px-2 py-2 md:px-4 md:py-4  bg-white shadow-xl flex flex-col font-roboto items-center justify-between">
