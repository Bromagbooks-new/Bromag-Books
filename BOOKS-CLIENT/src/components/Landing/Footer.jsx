...
const Footer = ()=> {
    ...
    return <footer className="border-t-2 mt-20 border-landing-primary font-space-grotesk flex p-10 gap-32">
        <div className='flex items-center justify-center'>
            <img src={logo} className='-mt-10'/>
            <div className='-ml-12 mt-8 text-center'>
                <p className='font-roboto text-[80px] font-semibold uppercase text-landing-primary'>BROMAG BOOKS</p>
                <p className='uppercase text-2xl -mt-5'>Copyrights owned by bromag india private limited.</p>
        ...
        <div className='flex flex-col gap-3 text-xl font-bold text-center'>
