    ...
    <>
      ...
      >
        <div className="  relative ">
          <img
            className="relative h-96 w-96 md:h-[50rem] overflow-x-hidden md:w-[50rem] left-[12.5rem]  md:left-[58%] top-[3rem] md:top-[9rem]"
            src={heroEffect}
          />
        </div>
      ...
      <div className="relative bottom-[25rem] md:bottom-[40rem] font-bold md:w-[60%] h-0 py-10 md:p-0 pl-4 md:pl-20 flex flex-col gap-2 md:gap-4 font-roboto">
        <p className="font-bold text-5xl md:text-8xl lg:text-8xl font-roboto-condensed tracking-tighter" style={{ background: 'linear-gradient(90deg, #125B8F 0%, #051A29 100%)', WebkitBackgroundClip: 'text', color: 'transparent' }}>
          BROMAG BOOKS
        </p>

        <p className="w-4/5 md:w-auto text-base/5 lg:text-3xl  text-[#8C9FAE] font-normal font-roboto ">
