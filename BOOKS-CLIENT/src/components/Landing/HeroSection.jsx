...
const HeroSection = () => {
  return (
    <div className="relative bottom-[10rem] md:bottom-[15rem] left-[5%] md:left-[4%] z-20 w-11/12 md:w-[85rem] h-42 md:h-56 border-3 rounded-full bg-white border-landing-primary flex items-center justify-center md:gap-10">
