...
const DownloadBill = ({ bill, billItems, instructions, paymentMode }) => {
  ...
  return (
    <DialogContent className="max-w-none w-auto p-0 flex flex-col items-center bg-transparent border-0">
      <div ref={targetRef} className="max-w-none rounded-2xl w-[24rem] px-0 py-4 flex flex-col justify-between gap-3 bg-white shadow">
        ...
        <div className="fixed top-4 left-4">
          <DownloadIcon className="cursor-pointer" onClick={toPDF}>Download</DownloadIcon>
        </div>
    </DialogContent>
  );
};
